...
WebUI.click(findTestObject('Tim Ahli Landing Page/Nama dr. Mikhael Yosia, DTMH, BMedSci, PGCert, MKK'))
...
List<TestObject> testObjects = [findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text Dokter Spesialis Anak'),
	findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text dr. Mikhael Yosia, DTMH, BMedSci, PGCert, MKK')
	, findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Hyperlink Profil Profesional')
    , findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Profile Summary'), findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text Pendidikan')
    , findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Tahun Pendidikan'), findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text University')
    , findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text Jurusan'), findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text Pengalaman')
    , findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text Tahun Pengalaman'), findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text Artikel Lain')
    , findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Text Title Artikel'), findTestObject('Object Repository/Tim Ahli detail page/dr Mikhael/Hyperlink Tim Penulis')
    ]
