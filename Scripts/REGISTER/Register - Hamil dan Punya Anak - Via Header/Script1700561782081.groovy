...
WebUI.selectOptionByLabel(findTestObject('Membership Registration/select_Pilih Kondisi Ibu Saat Ini'), 'Sedang Hamil & Memiliki Anak', 
    false)

WebUI.selectOptionByLabel(findTestObject('Membership Registration/SelectUsiaKehamilan'), '12 Minggu', false)

WebUI.setText(findTestObject('Membership Registration/formDOBAnak'), '2023-02-01')
