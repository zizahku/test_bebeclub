...
WebUI.setText(findTestObject('Membership Registration/Nomor Handphone'), '085784018007')
...
WebUI.verifyElementPresent(findTestObject('Membership Registration/button_Kirim Kode OTP'), 2)
...
WebUI.verifyTextPresent('Nomor Handphone Sudah Pernah Dipakai', false)
